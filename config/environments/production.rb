Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "roadster_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'still-island-75426.herokuapp.com'}
 
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address:              'smtp.gmail.com',
    port:                 587,
    domain:               'still-island-75426.herokuapp.com',
